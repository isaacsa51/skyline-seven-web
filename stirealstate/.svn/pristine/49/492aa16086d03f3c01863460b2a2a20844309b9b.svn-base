...
<div class="content-wrapper">
  <div class="encabezado-modulo">
    <h2 class="titulo-modulo">Imagenes de atracction home</h2>
    <button id="add">Nueva Imagen</button>
  </div>
...
<script src="<?php echo base_url('assets/js/admin/atracctionhome.js'); ?>"></script>
