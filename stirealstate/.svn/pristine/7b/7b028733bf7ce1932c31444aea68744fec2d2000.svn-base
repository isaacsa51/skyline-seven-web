...
<div class="content-wrapper">
  <div class="encabezado-modulo">
    <h2 class="titulo-modulo">Gerentes</h2>
    <button id="add">Nuevo Gerente</button>
  </div>
  ...
  <table class="table-desktop">
    <thead>
      <tr>
        ...
        <th scope="col">No. Asociado</th>
        <th scope="col">No. Tienda</th>
...
<script src="<?php echo base_url('assets/js/admin/gerentes.js'); ?>"></script>
