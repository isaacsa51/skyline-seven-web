...
class QRimage {
    ...
    //----------------------------------------------------------------------
    public static function png_back($frame, $filename = false, $pixelPerPoint = 4, $outerFrame = 4,$saveandprint=FALSE)
    {
    ...
    public static function png($frame, $filename = false, $pixelPerPoint = 4, $outerFrame = 4,$saveandprint=FALSE)
    {
        ...
        $logo = './assets/img/logocuadrado.png';
        //$logo = "https://qrappdp.grupodp.com.mx/assets/img/logocuadrado.png";
        if($logo !== FALSE){
