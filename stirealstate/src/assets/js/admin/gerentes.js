...
$('#add').click(function(e) {
	...
	<div class="modal-input una-columna">
		...
		<input type="text" maxlength="70" id="nombre" name="nombre" class="form-control texto" placeholder="Nombre de gerente" >
		<small class="form-text text-danger"></small>
  </div>
  <div class="modal-input una-columna">
		<label class="col-form-label mr-2 control-label">Apellidos </label>
		<input type="text" maxlength="70" id="apellido" name="apellido" class="form-control texto" placeholder="Apellidos de gerente" >
		<small class="form-text text-danger"></small>
  </div>
  <div class="modal-input dos-columnas">
		<label class="col-form-label mr-2 control-label">No. Asociados </label>
		<input type="number" id="num_asociado" name="num_asociado" class="form-control texto" placeholder="Número de asociado" >
		<small class="form-text text-danger"></small>
  </div>
  <div class="modal-input dos-columnas">
		<label class="col-form-label mr-2 control-label">No. Tienda </label>
		<input type="number" id="num_tienda" name="num_tienda" class="form-control texto" placeholder="Número de tienda" >
		<small class="form-text text-danger"></small>
  </div>
  <div class="modal-input una-columna">
		<label class="col-form-label mr-2 control-label">Correo</label>
		<input type="text" maxlength="70" id="email" name="email" class="form-control texto" placeholder="Correo electrónico (@homedepot.com.mx)" >
		<small class="form-text text-danger"></small>
	</div>
	<div class="modal-input una-columna">
...
function prepareToDelete(id, nombre){
	deleteRow( id, `¿Seguro desea eliminar al gerente <b>${nombre}</b>?`, 'Gerentes/deleteGerente', 'Gerente eliminado' );
}
